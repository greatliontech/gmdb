...
// Overflow holds precomputed capacity values for overflow pages.
...
func (o Overflow) PagesNeeded(totalLen int) int {
...
// The returned slice is borrowed from buf.
func (o Overflow) ReadFollowerPage(buf []byte) []byte {
...
// Returns the number of value bytes written.
func (o Overflow) WriteFollowerPage(buf []byte, data []byte) int {
