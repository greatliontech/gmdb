...
| [lock-stalled-creator-test](lock-stalled-creator-test.md) | 2.4 | Add a test exercising `lock.Open`'s `errPartialInit` retry success branch (stalled-but-live creator) once chunk-2.4's flock-goroutine test-hook infrastructure lands. |
